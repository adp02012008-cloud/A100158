    ...
    <div className="login-bg">
      ...
      <footer className="login-footer-dock">
        <div className="login-footer-glass">
          {/* Header Bar with Brand & Connect Links */}
            ...
            <div className="login-footer-connect">
              ...
              <div className="login-footer-pills">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-pill-btn github"
                ...
                <a
                  href="tel:6380341239"
                  className="footer-pill-btn phone"
          ...
          <div className="login-footer-feedback">
            ...
            <div className="feedback-text-content">
              <span className="feedback-title">Have a query? Found a bug? Have a suggestion?</span>
              <span className="feedback-desc">Let me know — your feedback helps improve <strong>A#100158</strong>.</span>
            </div>
          </div>
