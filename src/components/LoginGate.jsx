    ...
    <div className="login-bg">
      ...
      <footer className="login-footer-bar">
        <div className="login-footer-inner">
          {/* Top Row: Brand on Left, Connect Links on Right */}
          <div className="login-footer-main-row">
            ...
            <div className="login-footer-connect">
              ...
              <div className="login-footer-connect-links">
                ...
                >
                  <svg className="login-footer-icon" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Middle Row: Feedback Banner */}
          <div className="login-footer-feedback-banner">
